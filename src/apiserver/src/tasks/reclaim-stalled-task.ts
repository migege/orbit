 ...
 * nudge it back: if NO other session for the task is still occupying it, revert
 * IN_PROGRESS -> OPEN so the abandoned work returns to the actionable pool. No-op
 * when another session is still live or the task isn't IN_PROGRESS.
 *
